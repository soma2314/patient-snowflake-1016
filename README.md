...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/patient-snowflake-1016)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/patient-snowflake-1016
```

A live public deployment of this template is available at [https://patient-snowflake-1016.templates.workers.dev](https://patient-snowflake-1016.templates.workers.dev)
